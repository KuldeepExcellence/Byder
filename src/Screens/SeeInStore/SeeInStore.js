    ...
    <>
      ...
      <View style={styles.man}>
        <View style={styles.Topimg}>
          ...
          <Text style={styles.txtMain}>Ver en tienda</Text>
          <TouchableOpacity onPress={() => navigation.navigate('StoreSubmit')} disabled={!enableStatus} style={[!enableStatus && styles.disabledButton]}>
