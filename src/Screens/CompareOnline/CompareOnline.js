import { StyleSheet, Text, View, StatusBar, TouchableOpacity, Image, TextInput, ImageBackground } from 'react-native'
...
const CompareOnline = ({ navigation }) => {
  ...
  const [ticketStatus, setTicketStatus] = React.useState(true); //when ticket raise
    ...
    <>
      ...
      <View style={styles.man}>
        <View style={styles.Topimg}>
          ...
          <Text style={styles.txtMain}>CompareOnline</Text>
          <TouchableOpacity onPress={() => navigation.navigate('Submit')} disabled={!enableStatus} style={[!enableStatus && styles.disabledButton]}>
      ...
      <View style={styles.main2}>
        {ticketStatus ?
          ...
          <View>
            <TouchableOpacity onPress={() => navigation.navigate('Submit')} style={styles.txman}>
