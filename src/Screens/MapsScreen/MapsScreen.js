import { StyleSheet, Text, View, StatusBar, ScrollView, Linking, Image,Platform, TouchableOpacity } from 'react-native'
            ...
            <ScrollView>
                <View style={styles.main2}>
                    ...
                    <TouchableOpacity onPress={() => Linking.openURL(url)} style={styles.map}>
                        <Image style={styles.mapimg} source={require('../../Assets/locationgoogle.png')} tintColor='#fff' />
